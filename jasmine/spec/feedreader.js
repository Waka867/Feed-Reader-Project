...
$(function() {
    ...
    */
    ...
    // Global loadfeed length declaration
    var len = loadFeed.length;

    // Global allFeeds length declaration
    var leng = allFeeds.length;
    ...
    describe('The menu', function() {
        ...
        var hamburger = $('.menu-icon-link').attr('');
    ...
    describe('Initial Entries', function() {
        ...
        // Makes sure feed is loaded before expectations are evaluated
    ...
    describe('New Feed Selection', function() {
        ...
        it('is actually new content', function(){
            feedItem = $('.entry').html();
            for(i = 0; i < len; i++) {
                expect($('.entry')).not.toEqual(feedItem);
            };
        });
    });
